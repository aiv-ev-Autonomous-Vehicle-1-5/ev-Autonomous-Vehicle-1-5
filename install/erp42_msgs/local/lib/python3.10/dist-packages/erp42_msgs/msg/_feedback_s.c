...
bool erp42_msgs__msg__feedback__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("erp42_msgs.msg._feedback.Feedback", full_classname_dest, 33) == 0);
  }
  erp42_msgs__msg__Feedback * ros_message = _ros_message;
  {  // header
  ...
  {  // encoder_count
    PyObject * field = PyObject_GetAttrString(_pymsg, "encoder_count");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->encoder_count = (int32_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // heartbeat
...
PyObject * erp42_msgs__msg__feedback__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("erp42_msgs.msg._feedback");
  ...
  {  // encoder_count
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->encoder_count);
    {
      int rc = PyObject_SetAttrString(_pymessage, "encoder_count", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
