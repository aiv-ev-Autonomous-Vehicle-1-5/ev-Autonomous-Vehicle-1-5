...
bool erp42_msgs__msg__control_command__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("erp42_msgs.msg._control_command.ControlCommand", full_classname_dest, 46) == 0);
  }
  erp42_msgs__msg__ControlCommand * ros_message = _ros_message;
  {  // speed
...
PyObject * erp42_msgs__msg__control_command__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("erp42_msgs.msg._control_command");
