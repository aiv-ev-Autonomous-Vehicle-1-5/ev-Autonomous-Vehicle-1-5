...
bool ev_msgs__msg__cone__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ev_msgs.msg._cone.Cone", full_classname_dest, 22) == 0);
  }
  ev_msgs__msg__Cone * ros_message = _ros_message;
  {  // position
...
PyObject * ev_msgs__msg__cone__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("ev_msgs.msg._cone");
