...
{
  new (message_memory) ev_msgs::msg::ConeArray(_init);
}

void ConeArray_fini_function(void * message_memory)
{
  auto typed_message = static_cast<ev_msgs::msg::ConeArray *>(message_memory);
  typed_message->~ConeArray();
}

size_t size_function__ConeArray__cones(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<ev_msgs::msg::Cone> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<ev_msgs::msg::Cone> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<ev_msgs::msg::Cone> *>(untyped_member);
  return &member[index];
}
...
{
  const auto & item = *reinterpret_cast<const ev_msgs::msg::Cone *>(
    get_const_function__ConeArray__cones(untyped_member, index));
  auto & value = *reinterpret_cast<ev_msgs::msg::Cone *>(untyped_value);
  value = item;
}
...
{
  auto & item = *reinterpret_cast<ev_msgs::msg::Cone *>(
    get_function__ConeArray__cones(untyped_member, index));
  const auto & value = *reinterpret_cast<const ev_msgs::msg::Cone *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ConeArray_message_member_array[2] = {
  {
    ...
    offsetof(ev_msgs::msg::ConeArray, header),  // bytes offset in struct
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<ev_msgs::msg::Cone>(),  // members of sub message
    true,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(ev_msgs::msg::ConeArray, cones),  // bytes offset in struct
    nullptr,  // default value
...
get_message_type_support_handle<ev_msgs::msg::ConeArray>()
{
  return &::ev_msgs::msg::rosidl_typesupport_introspection_cpp::ConeArray_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ev_msgs, msg, ConeArray)() {
  return &::ev_msgs::msg::rosidl_typesupport_introspection_cpp::ConeArray_message_type_support_handle;
}
