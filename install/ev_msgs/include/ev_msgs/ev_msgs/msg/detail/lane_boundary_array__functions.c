...
ev_msgs__msg__LaneBoundaryArray__init(ev_msgs__msg__LaneBoundaryArray * msg)
{
  ...
  if (!std_msgs__msg__Header__init(&msg->header)) {
    ev_msgs__msg__LaneBoundaryArray__fini(msg);
    return false;
  }
  // boundaries
  if (!ev_msgs__msg__LaneBoundary__Sequence__init(&msg->boundaries, 0)) {
    ev_msgs__msg__LaneBoundaryArray__fini(msg);
    return false;
  }
  return true;
...
ev_msgs__msg__LaneBoundaryArray__fini(ev_msgs__msg__LaneBoundaryArray * msg)
{
  ...
  // boundaries
  ev_msgs__msg__LaneBoundary__Sequence__fini(&msg->boundaries);
}
...
ev_msgs__msg__LaneBoundaryArray__are_equal(const ev_msgs__msg__LaneBoundaryArray * lhs, const ev_msgs__msg__LaneBoundaryArray * rhs)
{
  ...
  // boundaries
  if (!ev_msgs__msg__LaneBoundary__Sequence__are_equal(
  ...
  ev_msgs__msg__LaneBoundaryArray * output)
{
  ...
  // boundaries
  if (!ev_msgs__msg__LaneBoundary__Sequence__copy(
...
ev_msgs__msg__LaneBoundaryArray__create()
{
  ...
  ev_msgs__msg__LaneBoundaryArray * msg = (ev_msgs__msg__LaneBoundaryArray *)allocator.allocate(sizeof(ev_msgs__msg__LaneBoundaryArray), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(ev_msgs__msg__LaneBoundaryArray));
  bool success = ev_msgs__msg__LaneBoundaryArray__init(msg);
  if (!success) {
...
ev_msgs__msg__LaneBoundaryArray__Sequence__init(ev_msgs__msg__LaneBoundaryArray__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ev_msgs__msg__LaneBoundaryArray * data = NULL;

  if (size) {
    data = (ev_msgs__msg__LaneBoundaryArray *)allocator.zero_allocate(size, sizeof(ev_msgs__msg__LaneBoundaryArray), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = ev_msgs__msg__LaneBoundaryArray__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        ev_msgs__msg__LaneBoundaryArray__fini(&data[i - 1]);
      }
...
ev_msgs__msg__LaneBoundaryArray__Sequence__fini(ev_msgs__msg__LaneBoundaryArray__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      ev_msgs__msg__LaneBoundaryArray__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ev_msgs__msg__LaneBoundaryArray__Sequence * array = (ev_msgs__msg__LaneBoundaryArray__Sequence *)allocator.allocate(sizeof(ev_msgs__msg__LaneBoundaryArray__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = ev_msgs__msg__LaneBoundaryArray__Sequence__init(array, size);
  if (!success) {
...
ev_msgs__msg__LaneBoundaryArray__Sequence__destroy(ev_msgs__msg__LaneBoundaryArray__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    ev_msgs__msg__LaneBoundaryArray__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
ev_msgs__msg__LaneBoundaryArray__Sequence__are_equal(const ev_msgs__msg__LaneBoundaryArray__Sequence * lhs, const ev_msgs__msg__LaneBoundaryArray__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!ev_msgs__msg__LaneBoundaryArray__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  ev_msgs__msg__LaneBoundaryArray__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(ev_msgs__msg__LaneBoundaryArray);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    ev_msgs__msg__LaneBoundaryArray * data =
      (ev_msgs__msg__LaneBoundaryArray *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!ev_msgs__msg__LaneBoundaryArray__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          ev_msgs__msg__LaneBoundaryArray__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!ev_msgs__msg__LaneBoundaryArray__copy(
