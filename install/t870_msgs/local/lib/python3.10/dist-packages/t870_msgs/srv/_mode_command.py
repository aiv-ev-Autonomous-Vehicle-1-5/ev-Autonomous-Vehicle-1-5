...
class Metaclass_ModeCommand_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('t870_msgs')
        except ImportError:
            import logging
            import traceback
...
class Metaclass_ModeCommand(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from t870_msgs.srv import _mode_command
...
class ModeCommand(metaclass=Metaclass_ModeCommand):
    from t870_msgs.srv._mode_command import ModeCommand_Request as Request
    from t870_msgs.srv._mode_command import ModeCommand_Response as Response
