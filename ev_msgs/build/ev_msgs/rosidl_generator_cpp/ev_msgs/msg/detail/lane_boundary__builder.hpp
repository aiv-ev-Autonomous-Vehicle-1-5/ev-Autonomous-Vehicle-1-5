...
{
public:
  explicit Init_LaneBoundary_side(::ev_msgs::msg::LaneBoundary & msg)
  : msg_(msg)
  {}
  Init_LaneBoundary_confidence side(::ev_msgs::msg::LaneBoundary::_side_type arg)
  {
...
public:
  ...
  : msg_(msg)
  {}
  Init_LaneBoundary_side points(::ev_msgs::msg::LaneBoundary::_points_type arg)
  {
