...
#ifndef EV_MSGS__MSG__DETAIL__B_BOX__TRAITS_HPP_
#define EV_MSGS__MSG__DETAIL__B_BOX__TRAITS_HPP_
...
inline std::string to_yaml(const ev_msgs::msg::BBox & msg)
{
  return ev_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<ev_msgs::msg::BBox>()
{
  return "ev_msgs::msg::BBox";
}

template<>
inline const char * name<ev_msgs::msg::BBox>()
{
  return "ev_msgs/msg/BBox";
}

template<>
struct has_fixed_size<ev_msgs::msg::BBox>
  : std::integral_constant<bool, has_fixed_size<geometry_msgs::msg::Point>::value> {};

template<>
struct has_bounded_size<ev_msgs::msg::BBox>
  : std::integral_constant<bool, has_bounded_size<geometry_msgs::msg::Point>::value> {};

template<>
struct is_message<ev_msgs::msg::BBox>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // EV_MSGS__MSG__DETAIL__B_BOX__TRAITS_HPP_
