...
#include "ev_msgs/msg/detail/b_box__rosidl_typesupport_fastrtps_c.h"
...
using _BBox__ros_msg_type = ev_msgs__msg__BBox;
...
static uint32_t _BBox__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ev_msgs__msg__BBox(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ev_msgs__msg__BBox;
    is_plain =
      (
...
static size_t _BBox__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ev_msgs__msg__BBox(
