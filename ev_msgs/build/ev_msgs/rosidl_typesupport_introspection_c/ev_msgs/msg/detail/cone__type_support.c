...
static rosidl_typesupport_introspection_c__MessageMember ev_msgs__msg__Cone__rosidl_typesupport_introspection_c__Cone_message_member_array[5] = {
  {
    "position",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ev_msgs__msg__Cone, radius),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ev_msgs__msg__Cone, height),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
