...
#include "ev_msgs/msg/detail/cone__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const ev_msgs::msg::Cone & ros_message,
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ev_msgs::msg::Cone;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ev_msgs::msg::Cone *>(
    untyped_ros_message);
...
{
  return &ev_msgs::msg::typesupport_fastrtps_cpp::_Cone__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ev_msgs, msg, Cone)() {
  return &ev_msgs::msg::typesupport_fastrtps_cpp::_Cone__handle;
}
