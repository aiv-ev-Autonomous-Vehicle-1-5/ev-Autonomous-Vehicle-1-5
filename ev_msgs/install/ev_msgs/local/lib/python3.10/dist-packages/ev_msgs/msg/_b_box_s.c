...
bool ev_msgs__msg__b_box__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ev_msgs.msg._b_box.BBox", full_classname_dest, 23) == 0);
  }
  ev_msgs__msg__BBox * ros_message = _ros_message;
  {  // position
  ...
  {  // size_z
    ...
    assert(PyFloat_Check(field));
    ros_message->size_z = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // confidence
...
PyObject * ev_msgs__msg__b_box__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("ev_msgs.msg._b_box");
  ...
  {  // size_z
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->size_z);
    {
