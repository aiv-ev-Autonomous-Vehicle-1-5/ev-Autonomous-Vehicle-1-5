...
class Init_Cone_size_z
{
public:
  explicit Init_Cone_size_z(::ev_msgs::msg::Cone & msg)
  : msg_(msg)
  {}
  Init_Cone_confidence size_z(::ev_msgs::msg::Cone::_size_z_type arg)
  {
...
class Init_Cone_size_y
{
public:
  explicit Init_Cone_size_y(::ev_msgs::msg::Cone & msg)
  : msg_(msg)
  {}
  Init_Cone_size_z size_y(::ev_msgs::msg::Cone::_size_y_type arg)
  {
    msg_.size_y = std::move(arg);
    return Init_Cone_size_z(msg_);
  }
...
class Init_Cone_size_x
{
public:
  explicit Init_Cone_size_x(::ev_msgs::msg::Cone & msg)
  : msg_(msg)
  {}
  Init_Cone_size_y size_x(::ev_msgs::msg::Cone::_size_x_type arg)
  {
    msg_.size_x = std::move(arg);
    return Init_Cone_size_y(msg_);
  }
...
public:
  ...
  {}
  Init_Cone_size_x position(::ev_msgs::msg::Cone::_position_type arg)
  {
    msg_.position = std::move(arg);
    return Init_Cone_size_x(msg_);
  }
