...
bool track_msgs__msg__planner_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("track_msgs.msg._planner_status.PlannerStatus", full_classname_dest, 44) == 0);
  }
  track_msgs__msg__PlannerStatus * ros_message = _ros_message;
  {  // header
...
PyObject * track_msgs__msg__planner_status__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("track_msgs.msg._planner_status");
