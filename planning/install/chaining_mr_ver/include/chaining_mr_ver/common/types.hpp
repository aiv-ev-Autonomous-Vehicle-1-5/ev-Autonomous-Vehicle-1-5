/**
 * @file types.hpp
 * @brief chaining_mr_ver 패키지 전체에서 사용하는 공통 자료구조 정의
 *
 ...
 * ──────────────────────────────────────────────────────────────────
 */
#ifndef CHAINING_MR_VER__COMMON__TYPES_HPP_
#define CHAINING_MR_VER__COMMON__TYPES_HPP_
 ...
 *
 * 체이닝된 경계점. CostmapGenerator에서 type에 따라
...
#endif  // CHAINING_MR_VER__COMMON__TYPES_HPP_
