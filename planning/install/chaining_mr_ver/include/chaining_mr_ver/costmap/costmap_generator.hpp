 ...
 * @brief Magnetic Resistance Costmap 생성기 — 체인 입력 버전
 *
 * ──────────────────────────────────────────────────────────────────
 ...
 * lc_ver에서는 체이너가 출력한 좌/우 ChainedPoint 체인을 직접 받는다.
 * ChainedPoint.type에 따라 콘/차선 각각의 cost 파라미터를 적용한다.
 */
#ifndef CHAINING_MR_VER__COSTMAP__COSTMAP_GENERATOR_HPP_
#define CHAINING_MR_VER__COSTMAP__COSTMAP_GENERATOR_HPP_
...
#endif  // CHAINING_MR_VER__COSTMAP__COSTMAP_GENERATOR_HPP_
