/**
 * @file types.hpp
 * @brief chaining_CDT 패키지 전체에서 사용하는 공통 자료구조 정의
 *
 ...
 * ──────────────────────────────────────────────────────────────────
 */
#ifndef CHAINING_CDT__COMMON__TYPES_HPP_
#define CHAINING_CDT__COMMON__TYPES_HPP_
...
#endif  // CHAINING_CDT__COMMON__TYPES_HPP_
