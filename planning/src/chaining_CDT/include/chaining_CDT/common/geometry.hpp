 ...
 * [파이프라인 내 역할]
 *
 *   이 헤더는 chaining_CDT 패키지의 **모든 모듈**에서 공통으로
 ...
 * ──────────────────────────────────────────────────────────────
 */
#ifndef CHAINING_CDT__COMMON__GEOMETRY_HPP_
#define CHAINING_CDT__COMMON__GEOMETRY_HPP_
...
#endif  // CHAINING_CDT__COMMON__GEOMETRY_HPP_
