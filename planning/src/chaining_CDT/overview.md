...
**1-4. debug_publish.hpp** — 그대로 복사, namespace만 `chaining_CDT`로 변경
...
**4-2. package.xml** — mr_ver 기반, 이름만 `chaining_CDT`
...
1. **빌드**: `cd ~/ev_ws/planning && colcon build --packages-select chaining_CDT`
2. **실행**: `ros2 launch chaining_CDT planning_lc.launch.py`
