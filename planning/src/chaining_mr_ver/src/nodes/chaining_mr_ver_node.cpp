 ...
 */
// ── 프로젝트 내부 헤더 ──
#include "chaining_mr_ver/nodes/chaining_mr_ver_node.hpp"   // LCPlannerNode 클래스 선언
#include "chaining_mr_ver/common/geometry.hpp"          // dist(), cross2(), to_path_msg() 등 기하 유틸
#include "chaining_mr_ver/common/debug_publish.hpp"     // 디버그 시각화 헬퍼
#include "chaining_mr_ver/safety/safety_checker.hpp"    // safety_checker::check() — 곡률/속도 검사
...
RCLCPP_COMPONENTS_REGISTER_NODE(chaining_mr_ver::LCPlannerNode)
