 ...
 */
// ── 프로젝트 내부 헤더 ──
#include "planning_lc_ver/nodes/lc_planner_node.hpp"   // LCPlannerNode 클래스 선언
#include "planning_lc_ver/common/geometry.hpp"          // dist(), cross2(), to_path_msg() 등 기하 유틸
#include "planning_lc_ver/common/debug_publish.hpp"     // 디버그 시각화 헬퍼
#include "planning_lc_ver/safety/safety_checker.hpp"    // safety_checker::check() — 곡률/속도 검사
