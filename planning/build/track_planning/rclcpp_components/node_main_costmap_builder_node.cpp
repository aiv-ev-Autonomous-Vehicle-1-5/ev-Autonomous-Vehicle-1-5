...
#define NODE_MAIN_LOGGER_NAME "costmap_builder_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libcostmap_builder_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<track_planning::CostmapBuilderNode>";
