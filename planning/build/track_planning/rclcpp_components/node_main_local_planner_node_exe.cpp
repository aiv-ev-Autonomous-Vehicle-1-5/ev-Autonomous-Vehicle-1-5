...
#define NODE_MAIN_LOGGER_NAME "local_planner_node_exe"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "liblocal_planner_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<track_planning::LocalPlannerNode>";
