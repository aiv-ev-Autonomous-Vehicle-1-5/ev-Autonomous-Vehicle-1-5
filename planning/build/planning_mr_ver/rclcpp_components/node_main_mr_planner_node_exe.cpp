...
#define NODE_MAIN_LOGGER_NAME "mr_planner_node_exe"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libmr_planner_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<planning_mr_ver::MRPlannerNode>";
