...
{
  new (message_memory) track_msgs::msg::ObstacleArray(_init);
}

void ObstacleArray_fini_function(void * message_memory)
{
  auto typed_message = static_cast<track_msgs::msg::ObstacleArray *>(message_memory);
  typed_message->~ObstacleArray();
}

size_t size_function__ObstacleArray__obstacles(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<track_msgs::msg::Obstacle> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<track_msgs::msg::Obstacle> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<track_msgs::msg::Obstacle> *>(untyped_member);
  return &member[index];
}
...
{
  const auto & item = *reinterpret_cast<const track_msgs::msg::Obstacle *>(
    get_const_function__ObstacleArray__obstacles(untyped_member, index));
  auto & value = *reinterpret_cast<track_msgs::msg::Obstacle *>(untyped_value);
  value = item;
}
...
{
  auto & item = *reinterpret_cast<track_msgs::msg::Obstacle *>(
    get_function__ObstacleArray__obstacles(untyped_member, index));
  const auto & value = *reinterpret_cast<const track_msgs::msg::Obstacle *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ObstacleArray_message_member_array[2] = {
  {
    ...
    offsetof(track_msgs::msg::ObstacleArray, header),  // bytes offset in struct
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<track_msgs::msg::Obstacle>(),  // members of sub message
    true,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(track_msgs::msg::ObstacleArray, obstacles),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers ObstacleArray_message_members = {
  ...
  2,  // number of fields
  sizeof(track_msgs::msg::ObstacleArray),
...
get_message_type_support_handle<track_msgs::msg::ObstacleArray>()
{
  return &::track_msgs::msg::rosidl_typesupport_introspection_cpp::ObstacleArray_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, track_msgs, msg, ObstacleArray)() {
  return &::track_msgs::msg::rosidl_typesupport_introspection_cpp::ObstacleArray_message_type_support_handle;
}
