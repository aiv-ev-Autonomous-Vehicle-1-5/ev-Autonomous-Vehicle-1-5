...
#ifndef TRACK_MSGS__MSG__DETAIL__OBSTACLE__TRAITS_HPP_
#define TRACK_MSGS__MSG__DETAIL__OBSTACLE__TRAITS_HPP_
...
inline void to_yaml(
  const track_msgs::msg::Obstacle & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const track_msgs::msg::Obstacle & msg)
{
  return track_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<track_msgs::msg::Obstacle>()
{
  return "track_msgs::msg::Obstacle";
}

template<>
inline const char * name<track_msgs::msg::Obstacle>()
{
  return "track_msgs/msg/Obstacle";
}

template<>
struct has_fixed_size<track_msgs::msg::Obstacle>
  : std::integral_constant<bool, has_fixed_size<geometry_msgs::msg::Point>::value && has_fixed_size<geometry_msgs::msg::Vector3>::value> {};

template<>
struct has_bounded_size<track_msgs::msg::Obstacle>
...
template<>
struct is_message<track_msgs::msg::Obstacle>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // TRACK_MSGS__MSG__DETAIL__OBSTACLE__TRAITS_HPP_
