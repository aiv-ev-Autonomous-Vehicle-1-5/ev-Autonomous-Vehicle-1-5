...
#include "track_msgs/msg/detail/planner_status__rosidl_typesupport_fastrtps_c.h"
...
using _PlannerStatus__ros_msg_type = track_msgs__msg__PlannerStatus;
...
size_t get_serialized_size_track_msgs__msg__PlannerStatus(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _PlannerStatus__ros_msg_type * ros_message = static_cast<const _PlannerStatus__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _PlannerStatus__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_track_msgs__msg__PlannerStatus(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_track_msgs
size_t max_serialized_size_track_msgs__msg__PlannerStatus(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = track_msgs__msg__PlannerStatus;
    is_plain =
      (
...
static size_t _PlannerStatus__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_track_msgs__msg__PlannerStatus(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, track_msgs, msg, PlannerStatus)() {
