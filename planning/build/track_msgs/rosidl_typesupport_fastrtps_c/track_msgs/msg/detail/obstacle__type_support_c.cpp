...
#include "track_msgs/msg/detail/obstacle__rosidl_typesupport_fastrtps_c.h"
...
using _Obstacle__ros_msg_type = track_msgs__msg__Obstacle;
...
static uint32_t _Obstacle__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_track_msgs__msg__Obstacle(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = track_msgs__msg__Obstacle;
    is_plain =
      (
...
static size_t _Obstacle__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_track_msgs__msg__Obstacle(
