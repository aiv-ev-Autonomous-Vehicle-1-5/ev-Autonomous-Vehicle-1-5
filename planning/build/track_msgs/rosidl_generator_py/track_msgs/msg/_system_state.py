...
class Metaclass_SystemState(type):
    ...
    def __prepare__(cls, name, bases, **kwargs):
        ...
        return {
            ...
            'STATE_INFEASIBLE': cls.__constants['STATE_INFEASIBLE'],
    ...
    @property
    def STATE_INFEASIBLE(self):
        """Message constant 'STATE_INFEASIBLE'."""
        return Metaclass_SystemState.__constants['STATE_INFEASIBLE']
