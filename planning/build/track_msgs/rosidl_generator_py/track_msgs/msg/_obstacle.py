...
class Metaclass_Obstacle(type):
    ...
    def __prepare__(cls, name, bases, **kwargs):
        ...
        return {
            'TYPE_STATIC': cls.__constants['TYPE_STATIC'],
            'TYPE_DYNAMIC': cls.__constants['TYPE_DYNAMIC'],
        }

    @property
    def TYPE_STATIC(self):
        """Message constant 'TYPE_STATIC'."""
        return Metaclass_Obstacle.__constants['TYPE_STATIC']

    @property
    def TYPE_DYNAMIC(self):
        """Message constant 'TYPE_DYNAMIC'."""
        return Metaclass_Obstacle.__constants['TYPE_DYNAMIC']
