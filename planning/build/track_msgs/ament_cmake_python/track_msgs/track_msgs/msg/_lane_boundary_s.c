...
bool track_msgs__msg__lane_boundary__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("track_msgs.msg._lane_boundary.LaneBoundary", full_classname_dest, 42) == 0);
  }
  track_msgs__msg__LaneBoundary * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of LaneBoundary */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("track_msgs.msg._lane_boundary");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "LaneBoundary");
