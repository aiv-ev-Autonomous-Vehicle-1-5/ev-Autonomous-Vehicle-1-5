...
bool track_msgs__msg__obstacle__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("track_msgs.msg._obstacle.Obstacle", full_classname_dest, 33) == 0);
  }
  track_msgs__msg__Obstacle * ros_message = _ros_message;
  {  // position
...
PyObject * track_msgs__msg__obstacle__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("track_msgs.msg._obstacle");
