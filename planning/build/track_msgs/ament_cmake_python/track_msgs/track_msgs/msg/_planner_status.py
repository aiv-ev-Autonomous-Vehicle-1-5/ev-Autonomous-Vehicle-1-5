...
class Metaclass_PlannerStatus(type):
    ...
    def OK(self):
        """Message constant 'OK'."""
        return Metaclass_PlannerStatus.__constants['OK']

    @property
    def STOP(self):
        """Message constant 'STOP'."""
        return Metaclass_PlannerStatus.__constants['STOP']

    @property
    def INFEASIBLE(self):
        """Message constant 'INFEASIBLE'."""
        return Metaclass_PlannerStatus.__constants['INFEASIBLE']

    @property
    def STALE(self):
        """Message constant 'STALE'."""
        return Metaclass_PlannerStatus.__constants['STALE']
