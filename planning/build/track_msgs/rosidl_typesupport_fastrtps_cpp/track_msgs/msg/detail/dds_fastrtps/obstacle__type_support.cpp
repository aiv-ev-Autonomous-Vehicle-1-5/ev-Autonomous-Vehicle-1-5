...
#include "track_msgs/msg/detail/obstacle__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = track_msgs::msg::Obstacle;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const track_msgs::msg::Obstacle *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<track_msgs::msg::Obstacle *>(
    untyped_ros_message);
...
{
  return &track_msgs::msg::typesupport_fastrtps_cpp::_Obstacle__handle;
}
