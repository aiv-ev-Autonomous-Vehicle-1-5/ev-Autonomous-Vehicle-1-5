...
#include "track_msgs/msg/detail/cone__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = track_msgs::msg::Cone;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const track_msgs::msg::Cone *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<track_msgs::msg::Cone *>(
    untyped_ros_message);
...
{
  return &track_msgs::msg::typesupport_fastrtps_cpp::_Cone__handle;
}
