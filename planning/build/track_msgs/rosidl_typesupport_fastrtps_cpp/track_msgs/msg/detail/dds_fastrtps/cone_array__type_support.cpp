...
#include "track_msgs/msg/detail/cone_array__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const track_msgs::msg::ConeArray & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  track_msgs::msg::ConeArray & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  // Member: cones
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        track_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_Cone(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = track_msgs::msg::ConeArray;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const track_msgs::msg::ConeArray *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<track_msgs::msg::ConeArray *>(
    untyped_ros_message);
...
{
  return &track_msgs::msg::typesupport_fastrtps_cpp::_ConeArray__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, track_msgs, msg, ConeArray)() {
  return &track_msgs::msg::typesupport_fastrtps_cpp::_ConeArray__handle;
}
