"""Debug Stage 7: Full pipeline (same as production).

Driver + Transform + CropBox + Patchwork++ + VoxelGrid + DBSCAN + Filter + Tracking.
Verify tracked output on /lidar/cones_tracked.
"""
...
def generate_launch_description():
    ...
    # Stage 7 (Full): Driver -> Transform -> CropBox -> Patchwork++ -> VoxelGrid -> DBSCAN -> Filter -> Tracking
