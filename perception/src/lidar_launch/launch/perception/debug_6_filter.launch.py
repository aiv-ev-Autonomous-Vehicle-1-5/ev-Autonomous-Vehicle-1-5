"""Debug Stage 6: Driver + Transform + CropBox + Patchwork++ + VoxelGrid + DBSCAN + Filter.

Verify filtered clusters on /clustering/filtered and cone detections on /clustering/cones.
"""
...
def generate_launch_description():
    ...
    # Stage 6: Driver -> Transform -> CropBox -> Patchwork++ -> VoxelGrid -> DBSCAN -> Filter
