"""Debug Stage 3: Driver + Transform + CropBox + Patchwork++.

Verify ground segmentation on /patchworkpp/ground and /patchworkpp/nonground.
"""
...
def generate_launch_description():
    ...
    # Stage 3: Driver -> Transform -> CropBox -> Patchwork++
