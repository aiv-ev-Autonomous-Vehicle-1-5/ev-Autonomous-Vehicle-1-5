...
#define NODE_MAIN_LOGGER_NAME "make_cylinder_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libmake_cylinder_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<make_cylinder::MakeCylinderNode>";
