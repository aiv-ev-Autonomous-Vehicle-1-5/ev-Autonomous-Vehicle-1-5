...
#define NODE_MAIN_LOGGER_NAME "serial_bridge_composable"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "liberp42_serial.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<erp42_serial::SerialBridge>";
