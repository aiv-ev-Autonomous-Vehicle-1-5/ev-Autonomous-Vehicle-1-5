...
static const _ModeCommand_Request_type_support_symbol_names_t _ModeCommand_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, erp42_msgs, srv, ModeCommand_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, erp42_msgs, srv, ModeCommand_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, erp42_msgs, srv, ModeCommand_Request)() {
  return &::erp42_msgs::srv::rosidl_typesupport_c::ModeCommand_Request_message_type_support_handle;
}
...
static const _ModeCommand_Response_type_support_symbol_names_t _ModeCommand_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, erp42_msgs, srv, ModeCommand_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, erp42_msgs, srv, ModeCommand_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, erp42_msgs, srv, ModeCommand_Response)() {
  return &::erp42_msgs::srv::rosidl_typesupport_c::ModeCommand_Response_message_type_support_handle;
}
...
static const _ModeCommand_type_support_symbol_names_t _ModeCommand_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, erp42_msgs, srv, ModeCommand)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, erp42_msgs, srv, ModeCommand)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, erp42_msgs, srv, ModeCommand)() {
  return &::erp42_msgs::srv::rosidl_typesupport_c::ModeCommand_service_type_support_handle;
}
