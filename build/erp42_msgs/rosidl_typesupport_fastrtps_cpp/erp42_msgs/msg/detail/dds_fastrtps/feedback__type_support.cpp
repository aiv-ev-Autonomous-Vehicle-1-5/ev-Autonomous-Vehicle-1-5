...
#include "erp42_msgs/msg/detail/feedback__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = erp42_msgs::msg::Feedback;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const erp42_msgs::msg::Feedback *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<erp42_msgs::msg::Feedback *>(
    untyped_ros_message);
...
{
  return &erp42_msgs::msg::typesupport_fastrtps_cpp::_Feedback__handle;
}
