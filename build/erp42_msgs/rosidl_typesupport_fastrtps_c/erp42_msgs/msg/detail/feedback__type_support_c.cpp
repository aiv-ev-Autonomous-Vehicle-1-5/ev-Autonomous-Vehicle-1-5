...
#include "erp42_msgs/msg/detail/feedback__rosidl_typesupport_fastrtps_c.h"
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_erp42_msgs
...
using _Feedback__ros_msg_type = erp42_msgs__msg__Feedback;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: encoder_count
  {
    cdr << ros_message->encoder_count;
  }
...
size_t get_serialized_size_erp42_msgs__msg__Feedback(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Feedback__ros_msg_type * ros_message = static_cast<const _Feedback__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name encoder_count
  {
    size_t item_size = sizeof(ros_message->encoder_count);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name heartbeat
...
static uint32_t _Feedback__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_erp42_msgs__msg__Feedback(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_erp42_msgs
size_t max_serialized_size_erp42_msgs__msg__Feedback(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = erp42_msgs__msg__Feedback;
    is_plain =
      (
...
static size_t _Feedback__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_erp42_msgs__msg__Feedback(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, erp42_msgs, msg, Feedback)() {
