...
bool ev_msgs__msg__lane_boundary__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ev_msgs.msg._lane_boundary.LaneBoundary", full_classname_dest, 39) == 0);
  }
  ev_msgs__msg__LaneBoundary * ros_message = _ros_message;
  {  // header
...
PyObject * ev_msgs__msg__lane_boundary__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("ev_msgs.msg._lane_boundary");
