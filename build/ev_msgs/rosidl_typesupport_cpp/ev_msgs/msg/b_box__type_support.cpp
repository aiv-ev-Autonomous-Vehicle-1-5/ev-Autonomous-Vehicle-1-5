...
static const _BBox_type_support_symbol_names_t _BBox_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ev_msgs, msg, BBox)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ev_msgs, msg, BBox)),
  }
};
...
{
  return &::ev_msgs::msg::rosidl_typesupport_cpp::BBox_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ev_msgs, msg, BBox)() {
  return get_message_type_support_handle<ev_msgs::msg::BBox>();
}
