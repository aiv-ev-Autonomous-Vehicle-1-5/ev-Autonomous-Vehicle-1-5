...
static const _BBoxArray_type_support_symbol_names_t _BBoxArray_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ev_msgs, msg, BBoxArray)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ev_msgs, msg, BBoxArray)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, ev_msgs, msg, BBoxArray)() {
  return &::ev_msgs::msg::rosidl_typesupport_c::BBoxArray_message_type_support_handle;
}
