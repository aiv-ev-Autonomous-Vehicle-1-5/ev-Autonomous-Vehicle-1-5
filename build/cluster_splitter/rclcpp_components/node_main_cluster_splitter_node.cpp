...
#define NODE_MAIN_LOGGER_NAME "cluster_splitter_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libcluster_splitter_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<cluster_splitter::ClusterSplitterNode>";
