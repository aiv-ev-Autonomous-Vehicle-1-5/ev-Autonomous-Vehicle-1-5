...
#define NODE_MAIN_LOGGER_NAME "dbscan_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libdbscan_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<dbscan_clustering::DBSCANNode>";
