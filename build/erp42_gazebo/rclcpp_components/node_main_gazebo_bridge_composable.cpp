...
#define NODE_MAIN_LOGGER_NAME "gazebo_bridge_composable"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "liberp42_gazebo.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<erp42_gazebo::GazeboBridge>";
