...
#include "t870_msgs/msg/detail/feedback__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = t870_msgs::msg::Feedback;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const t870_msgs::msg::Feedback *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<t870_msgs::msg::Feedback *>(
    untyped_ros_message);
...
{
  return &t870_msgs::msg::typesupport_fastrtps_cpp::_Feedback__handle;
}
