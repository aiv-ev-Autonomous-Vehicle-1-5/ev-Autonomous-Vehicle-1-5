...
#include "t870_msgs/msg/detail/control_command__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const t870_msgs::msg::ControlCommand & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  t870_msgs::msg::ControlCommand & ros_message)
{
  // Member: speed
  cdr >> ros_message.speed;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = t870_msgs::msg::ControlCommand;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const t870_msgs::msg::ControlCommand *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<t870_msgs::msg::ControlCommand *>(
    untyped_ros_message);
...
get_message_type_support_handle<t870_msgs::msg::ControlCommand>()
{
  return &t870_msgs::msg::typesupport_fastrtps_cpp::_ControlCommand__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, t870_msgs, msg, ControlCommand)() {
  return &t870_msgs::msg::typesupport_fastrtps_cpp::_ControlCommand__handle;
}
