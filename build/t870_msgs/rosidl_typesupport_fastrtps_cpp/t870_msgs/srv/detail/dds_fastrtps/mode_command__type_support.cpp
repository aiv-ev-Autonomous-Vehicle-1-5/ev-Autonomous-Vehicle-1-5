...
#include "t870_msgs/srv/detail/mode_command__rosidl_typesupport_fastrtps_cpp.hpp"
...
bool
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_t870_msgs
cdr_serialize(
  const t870_msgs::srv::ModeCommand_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  t870_msgs::srv::ModeCommand_Request & ros_message)
{
  // Member: manual_mode
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = t870_msgs::srv::ModeCommand_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const t870_msgs::srv::ModeCommand_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<t870_msgs::srv::ModeCommand_Request *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_t870_msgs
const rosidl_message_type_support_t *
get_message_type_support_handle<t870_msgs::srv::ModeCommand_Request>()
{
  return &t870_msgs::srv::typesupport_fastrtps_cpp::_ModeCommand_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, t870_msgs, srv, ModeCommand_Request)() {
  return &t870_msgs::srv::typesupport_fastrtps_cpp::_ModeCommand_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_t870_msgs
cdr_serialize(
  const t870_msgs::srv::ModeCommand_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: success
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  t870_msgs::srv::ModeCommand_Response & ros_message)
{
  // Member: success
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = t870_msgs::srv::ModeCommand_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const t870_msgs::srv::ModeCommand_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<t870_msgs::srv::ModeCommand_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &t870_msgs::srv::typesupport_fastrtps_cpp::_ModeCommand_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, t870_msgs, srv, ModeCommand_Response)() {
  return &t870_msgs::srv::typesupport_fastrtps_cpp::_ModeCommand_Response__handle;
}
...
{
  return &t870_msgs::srv::typesupport_fastrtps_cpp::_ModeCommand__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, t870_msgs, srv, ModeCommand)() {
  return &t870_msgs::srv::typesupport_fastrtps_cpp::_ModeCommand__handle;
}
