...
#include "t870_msgs/srv/detail/mode_command__rosidl_typesupport_fastrtps_c.h"
...
#include "t870_msgs/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
using _ModeCommand_Request__ros_msg_type = t870_msgs__srv__ModeCommand_Request;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_t870_msgs
size_t get_serialized_size_t870_msgs__srv__ModeCommand_Request(
  const void * untyped_ros_message,
...
static uint32_t _ModeCommand_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_t870_msgs__srv__ModeCommand_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_t870_msgs
size_t max_serialized_size_t870_msgs__srv__ModeCommand_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = t870_msgs__srv__ModeCommand_Request;
    is_plain =
      (
...
static size_t _ModeCommand_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_t870_msgs__srv__ModeCommand_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, t870_msgs, srv, ModeCommand_Request)() {
...
using _ModeCommand_Response__ros_msg_type = t870_msgs__srv__ModeCommand_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_t870_msgs
size_t get_serialized_size_t870_msgs__srv__ModeCommand_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ModeCommand_Response__ros_msg_type * ros_message = static_cast<const _ModeCommand_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_t870_msgs__srv__ModeCommand_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_t870_msgs
size_t max_serialized_size_t870_msgs__srv__ModeCommand_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = t870_msgs__srv__ModeCommand_Response;
    is_plain =
      (
...
static size_t _ModeCommand_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_t870_msgs__srv__ModeCommand_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, t870_msgs, srv, ModeCommand_Response)() {
...
// already included above
// #include "t870_msgs/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "t870_msgs/srv/mode_command.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, t870_msgs, srv, ModeCommand)() {
