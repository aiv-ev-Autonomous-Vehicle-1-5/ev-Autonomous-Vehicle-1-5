...
static const _ModeCommand_Request_type_support_symbol_names_t _ModeCommand_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, t870_msgs, srv, ModeCommand_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, t870_msgs, srv, ModeCommand_Request)),
  }
};
...
{
  return &::t870_msgs::srv::rosidl_typesupport_cpp::ModeCommand_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, t870_msgs, srv, ModeCommand_Request)() {
  return get_message_type_support_handle<t870_msgs::srv::ModeCommand_Request>();
}
...
static const _ModeCommand_Response_type_support_symbol_names_t _ModeCommand_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, t870_msgs, srv, ModeCommand_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, t870_msgs, srv, ModeCommand_Response)),
  }
};
...
{
  return &::t870_msgs::srv::rosidl_typesupport_cpp::ModeCommand_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, t870_msgs, srv, ModeCommand_Response)() {
  return get_message_type_support_handle<t870_msgs::srv::ModeCommand_Response>();
}
...
static const _ModeCommand_type_support_symbol_names_t _ModeCommand_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, t870_msgs, srv, ModeCommand)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, t870_msgs, srv, ModeCommand)),
  }
};
...
{
  return &::t870_msgs::srv::rosidl_typesupport_cpp::ModeCommand_service_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, t870_msgs, srv, ModeCommand)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<t870_msgs::srv::ModeCommand>();
}
