...
bool t870_msgs__msg__feedback__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("t870_msgs.msg._feedback.Feedback", full_classname_dest, 32) == 0);
  }
  t870_msgs__msg__Feedback * ros_message = _ros_message;
  {  // header
...
PyObject * t870_msgs__msg__feedback__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("t870_msgs.msg._feedback");
