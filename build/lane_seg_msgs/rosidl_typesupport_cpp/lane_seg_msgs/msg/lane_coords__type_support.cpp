...
static const _LaneCoords_type_support_symbol_names_t _LaneCoords_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, lane_seg_msgs, msg, LaneCoords)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, lane_seg_msgs, msg, LaneCoords)),
  }
};
...
{
  return &::lane_seg_msgs::msg::rosidl_typesupport_cpp::LaneCoords_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, lane_seg_msgs, msg, LaneCoords)() {
  return get_message_type_support_handle<lane_seg_msgs::msg::LaneCoords>();
}
