...
#define NODE_MAIN_LOGGER_NAME "lc_planner_node_exe"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "liblc_planner_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<chaining_costmap_ver::LCPlannerNode>";
